defmodule Domain.NotificationAppSlug do
  @moduledoc """
  Pure normalization and validation rules for readable notification app slugs.
  """
  ...
  @doc """
  Converts an app name into a lowercase kebab-case slug no longer than 50 characters.
  """
  ...
  def normalize(name) when is_binary(name) do
    ...
    if slug == "", do: "app", else: slug
  end

  def normalize(_name), do: "app"

  @doc """
  Returns whether a value is a valid lowercase notification app slug.
  """
